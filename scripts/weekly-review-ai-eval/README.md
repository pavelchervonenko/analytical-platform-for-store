...
и максимальную стоимость. Общий исторический лимит — 20 ₽; уже использовано 15,140 ₽, остаток —
4,860 ₽. Нельзя переносить старый cap или автоматически выполнять следующий case.
