...
import { payrollCategoryLabel, staleReasonLabel } from "./payroll-ui";
import "./styles.css";
...
function payrollErrorMessage(error: unknown): string {
  if (isApiClientError(error)) {
    ...
    if (error.status === 409) return "Версия уже изменилась. Данные перечитаны; проверьте актуальную версию и повторите действие.";
