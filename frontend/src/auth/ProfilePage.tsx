...
export function ProfilePage() {
  ...
  return <div className="profile-page">
    <header className="page-heading"><h1>Профиль и безопасность</h1></header>
    ...
    <div className="profile-grid">
      <aside className="panel profile-card">
        ...
        <div className="profile-security-note"><ShieldCheck /><span>Вход защищен. Пароль не хранится в браузере.</span></div>
      </aside>
