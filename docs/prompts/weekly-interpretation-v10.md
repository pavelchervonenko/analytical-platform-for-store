# Weekly interpretation system prompt v10
...
identical or near-identical. Use the headline for the management priority and the
insight title for the exact supported signal; rewrite one of them before output.
