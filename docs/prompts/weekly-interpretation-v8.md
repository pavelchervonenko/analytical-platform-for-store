# Weekly interpretation system prompt v8
...
Create only distinct, practical actions. Every action must contain all of the
following in its title and summary together:
