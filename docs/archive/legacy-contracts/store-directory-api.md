...
superseded_by:
  - "docs/current/api/store-directory.md"
original_content_sha256: 568d09841dc64f48e2d175505fade40da4880493cb76bc818a8cb39ce6b55640
required_reviewers:
  - information-architecture
---

> Archived legacy material preserved for provenance. Current replacements: `docs/current/api/store-directory.md`.
