...
superseded_by:
  - "docs/current/product/daily-store-pulse.md"
  - "docs/runbooks/daily-store-pulse.md"
original_content_sha256: 3821413097335eb5988f0bf1638dbc924770ddcfbec1f5b01eb66a1673c1915b
required_reviewers:
  - information-architecture
---

> Archived legacy material preserved for provenance. Current replacements: `docs/current/product/daily-store-pulse.md`, `docs/runbooks/daily-store-pulse.md`.
...
2. Завершить SALES, RETURNS и ORDERS sync за вчера.
