...
superseded_by:
  - "docs/current/api/store-data-status.md"
original_content_sha256: 5eee8e429345ba16b0d954053110f8522aef5d92b5098afb4a55851b9b7da766
required_reviewers:
  - information-architecture
---

> Archived legacy material preserved for provenance. Current replacements: `docs/current/api/store-data-status.md`.
