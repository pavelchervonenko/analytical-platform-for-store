...
superseded_by:
  - "docs/current/architecture/database.md"
original_content_sha256: 0e55b5fa3f3e83bf61127999a366886d59c0c9e0b7a2a3f9800c0eef21a6713a
required_reviewers:
  - information-architecture
---

> Archived legacy material preserved for provenance. Current replacements: `docs/current/architecture/database.md`.
