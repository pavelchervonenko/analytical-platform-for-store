...
superseded_by:
  - "docs/current/architecture/observability.md"
original_content_sha256: e3abcf5dc1a832aa52f32894dcf0bad15f300e4081b98f66cd5750345b0baccb
required_reviewers:
  - information-architecture
---

> Archived legacy material preserved for provenance. Current replacements: `docs/current/architecture/observability.md`.
