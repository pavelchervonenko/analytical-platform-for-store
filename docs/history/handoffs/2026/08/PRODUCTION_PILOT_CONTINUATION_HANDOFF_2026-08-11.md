...
original_content_sha256: 416c9a2b9451de3e75889db112ebe0a177174cba709464f87c21e17d5a51ad87
required_reviewers:
...
1. [deployment-and-operations.md](../../../../archive/legacy-contracts/deployment-and-operations.md) — architecture, production state
   and normative operations standard;
2. [production-deployment-runbook.md](../../../../archive/legacy-contracts/production-deployment-runbook.md) — release procedure;
3. [synchronization-api.md](../../../../archive/legacy-contracts/synchronization-api.md) — durable LiveSklad jobs and retry behavior;
4. [period-quality-api.md](../../../../archive/legacy-contracts/period-quality-api.md) and
   [data-quality-api.md](../../../../archive/legacy-contracts/data-quality-api.md) — quality gates;
5. [payroll-api.md](../../../../archive/legacy-contracts/payroll-api.md) and
   [payroll-classification-review.md](../../../audits/2026/08/payroll-classification-review.md) — payroll readiness and
   product classification;
6. [llm-production-operations.md](../../../../archive/legacy-contracts/llm-production-operations.md) and
   [weekly-snapshot-operations.md](../../../../archive/legacy-contracts/weekly-snapshot-operations.md) — AI operation;
7. [PROJECT_HANDOFF.md](PROJECT_HANDOFF.md) — wider repository context.
8. [PRODUCTION_PILOT_WORKING_PRACTICES.md](../../../../archive/legacy-contracts/PRODUCTION_PILOT_WORKING_PRACTICES.md) ? normative
