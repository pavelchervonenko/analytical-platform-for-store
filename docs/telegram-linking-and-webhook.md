...
6. Пройти ручную acceptance-матрицу и безопасную ротацию credentials из
   [telegram-staging-acceptance.md](telegram-staging-acceptance.md).
...
2. пройти и зафиксировать [staging acceptance](telegram-staging-acceptance.md) на release candidate.
