...
@Component
public class LlmAnalysisJobClaimStore {

    private final JdbcTemplate jdbcTemplate;
    private final LlmAnalysisJobStore jobStore;

    public LlmAnalysisJobClaimStore(
    ...
    public Optional<LlmAnalysisJob> claimNext(
        ...
        Instant leaseUntil = timestamp.plus(lease).isBefore(target.deadlineAt())
                ? timestamp.plus(lease)
                : target.deadlineAt();
        jdbcTemplate.update(
                """
