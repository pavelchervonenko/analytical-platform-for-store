...
@Service
public class LlmProviderCallCoordinator {

    private final LlmProviderCallClaimStore claimStore;
    private final LlmAnalysisJobLifecycleStore lifecycleStore;
    private final LlmAnalysisOperatorSignals operatorSignals;
    private final Clock clock;

    public LlmProviderCallCoordinator(
            LlmProviderCallClaimStore claimStore,
