...
@Service
public class LlmResponseValidationCoordinator {

    private final LlmValidationClaimStore claimStore;
    private final LlmAnalysisJobLifecycleStore lifecycleStore;
    private final LlmAnalysisOperatorSignals operatorSignals;
    private final Clock clock;

    public LlmResponseValidationCoordinator(
            LlmValidationClaimStore claimStore,
