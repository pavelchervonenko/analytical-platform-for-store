...
public class SyncJobStateMetrics implements MeterBinder {
    ...
    public SyncJobStateMetrics(SyncJobRepository jobRepository) {
    ...
    private record JobCounts(double failed, double retrying) {

        private static JobCounts unknown() {
            return new JobCounts(Double.NaN, Double.NaN);
        }
    }
}
